%
% GETIVARFEAT Gets the var feature (variance).
%
% feat = getvarfeat(x,winsize,wininc,datawin,dispstatus)
%
% 
%
% This function computes the VAR feature of the signals in x,
...
%
% Outputs
%    feat:     VAR value in a 2 dimensional matrix
%              dim1 window
%              dim2 feature (col i is the features for the signal in column i of x)
%
% Modifications
% Change feat output so that dim1 is window and dim2 is feature
% 

function feat = getvarfeat(x,winsize,wininc,datawin,dispstatus)
...
if dispstatus
    h = waitbar(0,'Computing VAR features...');
end
